...
function App() {
	...
	const [workList, setWorkList] = useState<Array<string>>([
		PortoImage,
		PortoImage,
		PortoImage,
		PortoImage,
					...
					<header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:min-h-screen lg:w-1/2 lg:flex-col justify-between lg:py-24">
						...
						<ul className="ml-1 mt-8 flex items-center">
							<li className='mr-7 text-xs'>
								<a className='block hover:text-slate-100' href='https://github.com/disinibale' target='_blank'>
							...
							<li className="mr-7 text-xs">
								<a className='block hover:text-slate-100' href='https://www.linkedin.com/in/disinibale' target='_blank'>
									<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
